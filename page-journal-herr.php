	...
	<div class="row">
		<main id="main" class="site-main col-md-9 text-left" role="main">
			...
			while ( have_posts() ) : the_post();
				...
				$journalP = get_page_by_path('higher-education-research-review', OBJECT, 'journal');
