	...
	<div class="row">
		<main id="main" class="site-main col-md-9 text-left" role="main">
			...
			while ( have_posts() ) : the_post();
				...
				$custom_post = get_page_by_path('the-graduate-school-journal', OBJECT, 'journal');
				$journal = (krischan_get_post_meta($custom_post->ID, '_krischan_settings_journal'));
				?>
